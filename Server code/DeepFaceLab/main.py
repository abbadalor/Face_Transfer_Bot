if __name__ == "__main__":
    ...
    def process_sort(arguments):
        ...
        #Sorter.main (input_path=Path(arguments.input_dir), sort_by_method="blur")
    ...
    p.add_argument('--input-dir', required=True, action=fixPathAction, dest="input_dir", help="Input directory. A directory containing the files you wish to process.")
    p.add_argument('--by', type=str, dest="sort_by_method", default=None, help="Method of sorting. 'origname' sort by original filename to recover original sequence." )
    ...
    def process_train(arguments):
        ...
        from mainscripts import Trainercopy
        Trainercopy.main(**kwargs)
    ...
    #p.add_argument('--force-model-name', required=True, dest="force_model_name", default=None, help="Forcing to choose model name from model/ folder.")
    p.add_argument('--cpu-only', action="store_true", dest="cpu_only", default=False, help="Train on CPU.")
    p.add_argument('--force-gpu-idxs', dest="force_gpu_idxs", default=None, help="Force to choose GPU indexes separated by comma.")
    #p.add_argument('--force-gpu-idxs', required=True, dest="force_gpu_idxs", default=None, help="Force to choose GPU indexes separated by comma.")
    ...
    def process_merge(arguments):
        ...
        Merger.main ( #arguments.model_name ->  v
    ...
    def process_videoed_extract_video(arguments):
        ...
        VideoEd.extract_video (arguments.input_file, arguments.output_dir, "png", 0)
