...
def sort_by_blur(input_path):
    ...
    path = os.path.join(os.getcwd(), "blurvalues.txt")
...
def sort_by_face_yaw(input_path):
    ...
    path = os.path.join(os.getcwd(), "yawvalues.txt")
    with open(path,"w") as outfile:
        json.dump(img_list, outfile)

    for img in img_list:
        if img[1] < -0.9 or img[1] > 0.9:
            os.remove(img[0])
...
def sort_by_face_pitch(input_path):
    ...
    path = os.path.join(os.getcwd(), "pitchvalues.txt")
    with open(path,"w") as outfile:
        json.dump(img_list, outfile)
...
def sort_by_brightness(input_path):
    ...
    path = os.path.join(os.getcwd(), "brightvalues.txt")
    with open(path,"w") as outfile:
        json.dump(img_list, outfile)
...
def sort_by_black(input_path):
    ...
    path = os.path.join(os.getcwd(), "blackvalues.txt")
    with open(path,"w") as outfile:
        json.dump(img_list, outfile)
